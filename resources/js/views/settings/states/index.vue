          ...
          <Td align="right" weight="medium">
            <div class="flex items-center justify-end gap-2">
              ...
              <router-link
                ...
                :to="`/settings/states/${item.id}/edit`"
...
const { filterableRef, setData, removeDB,access } = useIndexable(resource,'state')
