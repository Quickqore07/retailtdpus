          ...
          <Td align="right" weight="medium">
            <div class="flex items-center justify-end gap-2">
              ...
              <router-link
                ...
                :to="`/settings/regions/${item.id}/edit`"
...
const { filterableRef, setData, removeDB, access } = useIndexable(resource, 'region')
