<template>
    <div v-if="show" class="region-show">
        <Panel :divider="true">
            <template #header>
                <div class="flex items-center justify-between">
                    <h5 class="text-2xl font-bold">Region Details</h5>
                    <div class="flex items-center gap-2">
                        ...
                        :to="`/settings/regions/${model.id}/edit`">
                        </Button>
    ...
    <div v-else class="flex items-center justify-center min-h-[400px]">
        <Spinner size="md" text="Loading region details..." centered />
    </div>
</template>
...
const resource = route.meta?.resource || 'regions'

const { model, show, setData, removeDB, access } = useShowable(resource, 'region')
