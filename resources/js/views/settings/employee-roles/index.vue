<template>
  <div class="employee-roles-index">

    <Filterable
      ref="filterableRef"
      title="Employee Roles"
      url="settings/employee-roles"
    ...
    <template #extra>
      <Button 
        ...
        variant="primary" 
        size="sm" 
        to="/settings/employee-roles/create"
      >
        New Employee Role
      </Button>
    </template>
          ...
          <Td align="right" weight="medium">
            <div class="flex items-center justify-end gap-2">
              <router-link
                ...
                :to="`/settings/employee-roles/${item.id}`"
              ...
              <router-link
                ...
                :to="`/settings/employee-roles/${item.id}/edit`"
...
const { filterableRef, setData, removeDB, access } = useIndexable(resource, 'employee-role')
