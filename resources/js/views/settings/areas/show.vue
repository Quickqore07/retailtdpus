<template>
    <div v-if="show" class="area-show">
        <Panel :divider="true">
            <template #header>
                <div class="flex items-center justify-between">
                    <h5 class="text-2xl font-bold">Area Details</h5>
                    <div class="flex items-center gap-2">
                        ...
                        :to="`/settings/areas/${model.id}/edit`">
                        </Button>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <Label label="State" :value="model.region?.state?.name" />
    ...
    <div v-else class="flex items-center justify-center min-h-[400px]">
        <Spinner size="md" text="Loading area details..." centered />
    </div>
</template>
...
const resource = route.meta?.resource || 'areas'

const { model, show, setData, removeDB, access } = useShowable(resource, 'area')
