<template>
  <div class="upload-workgroups-index">
    <Filterable
      ref="filterableRef"
      title="Upload Workgroups"
      url="upload/workgroups"
          ...
          <Td align="right" weight="medium">
            <div class="flex items-center justify-end gap-2">
              ...
              <router-link
                ...
                :to="`/upload/workgroups/${item.id}/edit`"
...
const { filterableRef, setData, removeDB, access } = useIndexable(resource, 'upload-workgroup')
