<template>
  <div class="employee-rate-request-index">
    <Filterable
      ref="filterableRef"
      title="Employee New Rate Requests"
      url="payroll/employee-new-rate-request"
      :sortable="sortableColumns"
      :filter-groups="filterGroups"
      :create-button="access.includes('create')"
      create-route="/payroll/employee-new-rate-request/create"
    >
      <template #extra>
        <Button
          ...
          variant="primary"
          size="sm"
          to="/payroll/employee-new-rate-request/create"
        >
          New Rate Request
        </Button>
      </template>
          ...
          <Td align="right" weight="medium">
            <div class="flex items-center justify-end gap-2">
              ...
              <router-link
                ...
                :to="`/payroll/employee-new-rate-request/${item.id}`"
              ...
              <router-link
                ...
                :to="`/payroll/employee-new-rate-request/${item.id}/edit`"
...
const { setData, access } = useIndexable(resource, "employee-new-rate-request");
