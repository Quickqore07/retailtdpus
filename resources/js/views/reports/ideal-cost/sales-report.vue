<template>
    <div class="sales-report p-2 bg-gray-50 dark:bg-gray-900">
        <!-- Filter Panel -->
        <Panel class="mb-6">
            <div class="mb-6">
                ...
                <p class="text-sm text-gray-600 dark:text-gray-400">
                    Year-wise weekly totals by store (total_sales from daily sales)
                </p>
            </div>
                ...
                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                    <thead class="bg-gray-50 dark:bg-gray-900 md:sticky top-[-1px] !z-[101]">
                        <tr>
                            ...
                            <Th class="text-right w-[110px] md:sticky md:left-70 !z-[101] ">Total</Th>
                            <Th
                        ...
                        <tr>
                            <td :colspan="(reportPayload.weeks?.length ?? 0) + 3">
                                <NoData
                                    ...
                                    message="There is no sales data for the selected year. Please select a different year or ensure daily sales data has been entered."
                                    size="sm"
                                    icon-size="lg"
                                    :show-action="false"
...
const applyFilters = async () => {
    try {
        loading.value = true
        const response = await useRequest('post', '/reports/ideal-cost/sales', {
...
const exportReport = async () => {
    ...
    try {
        ...
        XLSX.writeFile(wb, `Sales_Report_${filters.value.year}.xlsx`)
