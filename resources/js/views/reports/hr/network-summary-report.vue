        ...
        <Panel class="mb-6">
            <div class="mb-6">
                ...
                <p class="text-sm text-gray-600 dark:text-gray-400">
                    View and analyze payroll data for all companies
                </p>
            </div>
...
const exportReport = async () => {
    try {
        ...
        await import('xlsx').then((XLSX) => {
            ...
            exportData.push(['Network Summary Report'])
            ...
            XLSX.utils.book_append_sheet(wb, ws, 'Network Summary Report')
            
            // Generate filename
            const filename = `Network_Summary_Report_${filters.value.selectedYear}_${new Date().getTime()}.xlsx`
