<template>
    <div class="cash-payout-sales-report p-2 bg-gray-50 dark:bg-gray-900">
        <!-- Filter Panel -->
        <Panel class="mb-6">
            <div class="mb-6">
                <h3 class="!text-lg !md:text-2xl font-bold text-gray-900 dark:text-white mb-2">
                    Cash Payout Sales Report
                </h3>
                <p class="text-sm text-gray-600 dark:text-gray-400">
                    View company-wise payout amounts for each day of the selected month
                </p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
                ...
                <div v-if="can('cash-payout-sales-report', 'regional-director')">
                    <DynamicDropdown
                ...
                <div v-if="can('cash-payout-sales-report', 'area-manager')">
                    <DynamicDropdown
...
const applyFilters = async () => {
    try {
        ...
        const response = await useRequest('post', '/reports/cash/cash-payout-sales', payload)
...
const exportReport = async () => {
    try {
        ...
        await import('xlsx').then((XLSX) => {
            ...
            exportData.push(['Cash Payout Sales Report'])
            ...
            XLSX.utils.book_append_sheet(wb, ws, 'Cash Payout Sales Report')

            const filename = `Cash_Payout_Sales_Report_${monthName.value}_${filters.value.selectedYear}_${new Date().getTime()}.xlsx`
