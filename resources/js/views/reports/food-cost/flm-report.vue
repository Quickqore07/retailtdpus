        ...
        <Panel class="mb-6">
            <div class="mb-6">
                ...
                <p class="text-sm text-gray-600 dark:text-gray-400">
                    View and analyze FLM data for the selected period
                </p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-5 gap-6 mb-6">
                ...
                <div v-if="can('flm-report', 'regional-director')">
                    <DynamicDropdown
                ...
                <div v-if="can('flm-report', 'area-manager')">
                    <DynamicDropdown
                        ...
                        <tr>
                            <td colspan="11">
                                <NoData
                                    ...
                                    message="There is no FLM data for the selected period. Please select a different date range or ensure data has been entered."
                                    size="sm"
                                    icon-size="lg"
                                    :show-action="false"
...
const applyFilters = async () => {
    try {
        loading.value = true;
        const response = await useRequest('post', '/reports/food-cost/flm', {
...
const exportReport = async () => {
    try {
        ...
        await import('xlsx').then((XLSX) => {
            ...
            XLSX.utils.book_append_sheet(wb, ws, 'FLM Report')
            
            // Generate filename
            const filename = `FLM_Report_${filters.value.selectedYear}_${new Date().getTime()}.xlsx`
